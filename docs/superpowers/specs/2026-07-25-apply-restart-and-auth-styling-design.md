...
**Status:** design v5 (approach approved 2026-07-25: **refuse-when-busy** self-restart) · **Author:** Fable 5 · **Cross-family spec review:** Sol — v5 PASS-WITH-NITS (5 passes; nits folded in); READY TO IMPLEMENT · **Base:** `main` @ `f6791ae` · **Branch:** `feat/apply-restart-auth-styling`
